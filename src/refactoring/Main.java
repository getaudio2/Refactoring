...
public class Main {
	public static void main(String[] args) throws ParseException {
		...
		date = dateFormat.parse("2/8/2006");
		...
		Client c = new Client("23232323Y","Leo Messi","123456789");
		c.afegeix(lloguer1);
		c.afegeix(lloguer2);
		c.afegeix(lloguer3);
		//System.out.println(c.informe());
		System.out.println(GestorLloquersLite(c));
		
	}
	
	public static String GestorLloquersLite(Client c) {
		return c.informe();
	}
}
